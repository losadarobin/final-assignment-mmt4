$(document).ready(function () {
    ...
    var allesSwitch = $('body,nav,#logo-blauw,#logo-wit,.switch-icon1,.switch-icon2,li a,h2,h4,h5,.kader-main,.video-js,.contact button,.ui-accordion-header,.acco-dicht-dark,.acco-dicht,.ui-accordion-header,h3,.ui-accordion-header-active,#popup')
